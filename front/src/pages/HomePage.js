...
import { FaQuestionCircle, FaBrain, FaCoins, FaGift, FaLongArrowAltRight, FaGlobeAmericas, FaFlask, FaBookOpen, FaFilm, FaMusic, FaHistory } from 'react-icons/fa';
import './HomePage.css';
  ...
  const categories = [
    {
      ...
      title: "Géographie",
      description: "Testez vos connaissances sur les pays, les capitales et les merveilles du monde."
    },
    {
      icon: <FaFlask className="text-5xl text-green-500" />,
      title: "Sciences",
      description: "Plongez dans l'univers fascinant de la physique, de la chimie et de la biologie."
    },
    {
      icon: <FaBookOpen className="text-5xl text-yellow-500" />,
      title: "Littérature",
      description: "Explorez les grands classiques et les œuvres contemporaines de la littérature mondiale."
    },
    {
      icon: <FaFilm className="text-5xl text-red-500" />,
      title: "Cinéma",
      description: "Mettez à l'épreuve vos connaissances sur les films, les acteurs et l'histoire du cinéma."
    },
    {
      icon: <FaMusic className="text-5xl text-purple-500" />,
      title: "Musique",
      description: "Testez votre culture musicale à travers les genres et les époques."
    },
    {
      icon: <FaHistory className="text-5xl text-brown-500" />,
      title: "Histoire",
      description: "Revivez les grands moments de l'histoire et découvrez des anecdotes fascinantes."
    }
  ];
  ...
  return (
    <div className="bg-gray-100">
      ...
      <div className="bg-purple-100 py-16">
        <div className="container mx-auto px-4 md:px-8 lg:px-16">
          <h2 className="text-3xl font-bold text-center mb-12">Explorez nos catégories de quiz</h2>
...
function CategoryCard({ icon, title, description }) {
  return (
    <div className="bg-white rounded-lg shadow-md p-6 flex flex-col items-center text-center cursor-pointer transform transition-all duration-300 hover:scale-105 hover:shadow-xl hover:bg-purple-50">
      <div className="mb-4">
        {icon}
      </div>
